      ...
      <div className="container relative z-10 pt-24 pb-16">
        ...
        >
          ...
          <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            ...
            <span className="text-primary glow-text">you actually</span>
            <br />
            <span className="text-foreground">understand.</span>
          </h1>

          <p className="text-lg text-muted-foreground max-w-xl mb-8 leading-relaxed">
            Every story comes with a plain-English "What It Means" breakdown.
            No jargon. No confusion. Just fast, actionable crypto intel.
          </p>
