...
const guides = [
  {
    title: "How to Start Crypto Trading in 2026",
    desc: "A step-by-step beginner guide to buying your first Bitcoin safely.",
    level: "Beginner",
    readTime: "8 min",
  },
  {
    title: "What Is Blockchain? Explained Simply",
    desc: "Understand the technology behind every cryptocurrency in plain English.",
    level: "Beginner",
    readTime: "5 min",
  },
  {
    title: "Best Crypto Wallets for Beginners",
    desc: "Compare hot vs cold wallets and find the best one for your needs.",
    level: "Beginner",
    readTime: "6 min",
  },
  {
    title: "Reading Crypto Charts — A Simple Guide",
    desc: "Learn candlesticks, support/resistance, and volume in 10 minutes.",
    level: "Intermediate",
    readTime: "10 min",
  },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {guides.map((guide, i) => (
            <motion.div
              ...
              className="group rounded-lg bg-card border border-border p-5 hover:border-primary/30 hover:bg-surface-hover transition-all cursor-pointer flex flex-col"
            >
              <div className="rounded-md bg-primary/10 p-2 w-fit mb-4">
