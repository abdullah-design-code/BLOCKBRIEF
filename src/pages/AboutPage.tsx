  ...
  <div className="min-h-screen bg-background">
    ...
    <main className="pt-24 pb-16">
      <div className="container max-w-3xl">
        <h1 className="font-heading text-3xl font-bold text-foreground mb-6">About ChainPulse</h1>
        <div className="space-y-5 text-foreground/80 leading-relaxed">
          <p>
            ChainPulse is a next-generation crypto news platform built with one mission: make cryptocurrency news accessible to everyone — especially beginners.
          </p>
          <p>
            While most crypto news sites use complex jargon and assume you already understand blockchain technology, ChainPulse breaks down every story into simple English with our signature <strong className="text-primary">"What It Means"</strong> section.
          </p>
          <p>
