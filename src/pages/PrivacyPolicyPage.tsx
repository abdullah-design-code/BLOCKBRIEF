    ...
    <main className="pt-24 pb-16">
      <div className="container max-w-3xl">
        ...
        <div className="space-y-5 text-foreground/80 leading-relaxed">
          ...
          <p>BlockBrief ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website.</p>
          ...
          <p>If you have questions about this Privacy Policy, please contact us at <a href="mailto:privacy@blockbrief.com" className="text-primary hover:underline">privacy@blockbrief.com</a>.</p>
        </div>
      </div>
    </main>
    <Footer />
